...
//    }    //Email end
    ...
    public static int deleteUserProperty(int sellOrRentPropertyID)
    {
        try
        {
            currentcon = ConnectionManager.GetConnection();
            PreparedStatement ps = null;
            ps = currentcon.prepareStatement("update tblsellorrentproperty set isDeleted=1 where SellOrRentPropertyID=?");
            ps.setInt(1, sellOrRentPropertyID);
