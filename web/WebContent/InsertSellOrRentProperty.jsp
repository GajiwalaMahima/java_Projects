...
<!--                                        <label style="font-weight: bold; display:none" id="lblLocation" name="lblLocation" >City Details added successfully.Please click on Next to proceed further.</label>-->
							...
							<input type="number" name="txtSuperBuildUpArea" class="form-control" style="width: 200px" placeholder="0"></input>
						</li>
                                            <li class="form-group">
                                        ...
                                        <ul class="list-inline margin-bottom-0">
                                            <li class="form-group">
                                                <label style="font-weight: bold">Build Up Area:</label>
                                                    <input type="number" name="txtBuildUpArea" class="form-control" style="width: 200px" placeholder="Build Up Area.."></input>
                                            </li>
                                            <li class="form-group">
                                                <label style="font-weight: bold">Area Unit:</label>    
							...
							<option value="-1">Area Unit</option>
                                            ...
                                            <li class="form-group">
                                                <label style="font-weight: bold">Carpet Area:</label>
                                                    <input type="number" name="txtCarpetArea" class="form-control" style="width: 200px" placeholder="Carpet Area.."></input>
                                            </li>
                                            <li class="form-group">
						<label style="font-weight: bold">Area Unit:</label>    
						...
						<label style="font-weight: bold">Expected Price(Rs):</label>
                                                <input type="number" name="txtExpectedPrice" class="form-control" style="width: 200px" placeholder="Expected Price.."></input>
                                            </li>
                                            <li class="form-group">
					...
					<label style="color: #000000; font-size: larger; font-weight: bold">Description:</label>
                                        <ul class="list-inline margin-bottom-0">
                                            <li>
						<textarea id="txtDescription" name="txtDescription" class="form-control" style="width: 500px" placeholder="Address.."></textarea>
                                            </li>
                                        </ul>
                                        <ul class="list-inline margin-bottom-0">
                                            <li class="form-group">
