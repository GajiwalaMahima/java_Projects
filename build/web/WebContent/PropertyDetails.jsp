...
session.setAttribute("PropertyId", no);
    try
    {
       ConnectionManager c = new ConnectionManager();
        Connection con = c.GetConnection();
        Statement st=con.createStatement();
        ResultSet rs=st.executeQuery("SELECT tblsellorrentproperty.SellOrRentPropertyID,tblsellorrentproperty.AmenitiesInternalCodes, tblsellorrentproperty.Description ,tblsellorrentproperty.Image1,tblsellorrentproperty.Image2,tblsellorrentproperty.Image3,tblpropertydetails.ExpectedPrice, tblpropertylocation.State,tblpropertylocation.City,tblpropertylocation.Address,tblpropertylocation.ProjectName, tblpropertydetails.SuperBuildUpArea, tblpropertydetails.BuildUpArea,tblpropertydetails.CarpetArea,tblpropertydetails.BedRooms, tblpropertydetails.BathRooms,tblpropertydetails.Balconies, tblpropertydetails.AgeOfProperty,tblpropertytype.PropertyyTypeName,tblpropertyavailability.PropertyAvailabilityName,tblregisteruser.UserName,tblpropertydetails.CreatedDateTime, tblpropertydetails.TotalFloors,AVG(tblfeedback.rating) from tblsellorrentproperty INNER JOIN tbllistpropertyfor ON tbllistpropertyfor.ListPropertyForID=tblsellorrentproperty.ListPropertyForID  INNER JOIN tblpropertylocation ON tblpropertylocation.PropertyLocationID=tblsellorrentproperty.PropertyLocationID INNER JOIN tblpropertydetails ON tblpropertydetails.PropertyDetailsID=tblsellorrentproperty.PropertyDetailsID INNER JOIN tblpropertytype ON tblsellorrentproperty.PropertyTypeInternalCode=tblpropertytype.PropertyTypeInternalCode INNER JOIN tblpropertyavailability ON tblpropertyavailability.PropertyAvailabilityInternalCode=tblpropertydetails.PropertyAvailabilityInternalCode INNER JOIN tblregisteruser ON tblregisteruser.RegisterUserID=tblsellorrentproperty.RegisterUserID INNER JOIN tblfeedback ON tblfeedback.SellOrRentPropertyID=tblsellorrentproperty.SellOrRentPropertyID WHERE tblsellorrentproperty.SellOrRentPropertyID='"+no+"';");
        ...
        <div class="row">
          <div class="col-lg-8" style="margin-top: -150px;">
            ...
            <div class="bg-white">
                <div class="row mb-5">
                    <div class="col-md-6">
                        <h4><output class="price rounded" value="&nbsp;&nbsp; " style="color: black"><%out.print("Expected Amount: "+rs.getString(7));%> </output></h4><br>
                        <h4><output class="price rounded" value="&nbsp;&nbsp; " style="color: black"><%out.print("Average Rating: "+rs.getString(24));%> </output></h4><br>
                    </div>
                    <div class="col-md-6">
                            ...
                            <div class="navbar">
                                <div class="navbar-inner">
                                    <ul class="nav nav-pills">
                                        <li ><a class="btn btn-primary" href="#tab1" data-toggle="tab">Floor Plans</a></li>&nbsp;&nbsp;
                                        <li><a class="btn btn-primary" href="#tab2" data-toggle="tab">Property Details</a></li>&nbsp;&nbsp;
                                        <li><a class="btn btn-primary" href="#tab3" data-toggle="tab">Location</a></li>&nbsp;&nbsp;
                                        <li><a class="btn btn-primary" href="#tab4" data-toggle="tab">Amenities</a></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
...
Connection conn = DriverManager.getConnection("jdbc:mysql://localhost:3306/dbrentalhousewebportal", "root", "");
...
%>
                                ...
                                <ul class="pager wizard">
                                    <li class="previous btn btn-secondary"><a href="javascript:void(0)">Previous</a></li> 
                                    <li class="next btn btn-secondary"><a href="javascript:void(0)">Next</a></li>
                                </ul>
                        </div>
                    </div>
                </div>
...
<label class="radio-inline">
 ...
 <label class="radio-inline">
     <input type="radio" value="5" name="optradio">Excellent&nbsp;&nbsp;&nbsp;
            ...
            <div class="form-group">
                <button type="submit" id="btnFeedback" class="btn btn-primary" value="Add Feedback">Add Feedback</button>
            </div>
        </div>
        </div>
    </div>
